...
const pass = new Audio('/app/CLAP/sound/pass.mp3')
const complete = new Audio('/app/CLAP/sound/complete.mp3')
const mosquito = new Audio('/app/CLAP/sound/mosquito.mp3')
const fail = new Audio('/app/CLAP/sound/blood.mp3')

const chart = new Donutty( document.getElementById('CLAP_donut'),{ 
  color: "#b22729",
  max : 15,
  value : 15,
  text: function(state) {
...
function onResults(results) {
  ...
  //console.log(l_hand.visibility, r_hand.visibility)
  //console.log(l_hand.x - r_hand.x)

  if(!results.poseLandmarks || Date.now() - lastTime < 1500)
    return
...
function start(isStep){
  ...
  intv = setInterval(()=>{
    ...
    */
    ...
    if(point == 3){
      pibo.extend('hand_right',{ pos : 'vvright'})
      pibo.extend('hand_left',{ pos : 'vvleft'})
    }
